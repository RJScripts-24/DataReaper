            ...
            {resources.map((resource, index) => (
              ...
              >
                ...
                <div style={{ padding: "24px" }}>
                  <span className="pencil-text" style={{ fontSize: "14px", fontWeight: 600, color: "#2b2b2b", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "8px", display: "block" }}>
                    {resource.tag}
                  </span>
                  <h4 className="pencil-heading" style={{ fontSize: "20px", fontWeight: 700, color: "#2b2b2b", lineHeight: 1.4 }}>
                    {resource.title}
                  </h4>
                </div>
              </motion.a>
